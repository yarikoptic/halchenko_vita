...
\item Research projects in vision.
\item Methodological and software developments for statistical analysis of neural data:
...
\section{Publications   (Google Scholar h-index: \gschttp{18}, i10-index: \gschttp{22})}
...
\item \rbibentry{VHG+biorxiv17} \openaccess  % Fam faces
