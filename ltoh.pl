...
# Modified by Yaroslav Halchenko yoh@cs.unm.edu to fit my needs
#							04/12/02
...
#    print "<HR>\n";
    print "<!--[Converted LaTeX --> HTML by http://www.best.com/~quong/ltoh.html -->";
#    print "</EM></font><br>\n";
