...
%   lab page
   ...
   \item[{O}pen{S}ource:]\hspace*{\fill}
      ...
      \item Coauthor PyMVPA (Python Multivariate Pattern Analysis
        toolbox \url{http://pkg-exppsy.alioth.debian.org/pymvpa/})
 ...
 \item
   \mauthors{ M. Hanke, Y.O. Halchenko, P.B. Sederberg, E. Olivetti, I. Frnd, J.W. Rieger, C.S. Herrmann, S.J. Hanson, S. Pollmann}
    \mtitle{PyMVPA: a unifying approach to the analysis of neuroscientific data}
    \mwhere{in preparation}

  \item
    \mauthors{M. Hanke, Y.O. Halchenko, P.B. Sederberg, S.J. Hanson, J.V. Haxby, S. Pollmann}
    \mtitle{PyMVPA: A Python to olb ox for multivariate pattern analysis of fMRI data}
    \mwhere{submitted}
