...
\address{
  ...
  \texttt{[973] 353-5440 x263 (Hanson's lab)}\\
}

%\address{
% \textbf{GnuPG KEYS:}\newline
% GPG key: \href{URL}{http://www.onerussian.com/gpg-yoh.asc}\\
% \wdescription{PGP fp: 3BB6 E124 0643 A615 6F00  6854 8D11 4563 75C0 24C8}
%}
...
\end{position}
 ...
 \begin{position}
   ...
   to transfer to NJIT I'm obtaining MS degree in CS @ UNM.
 \end{position}
 ...
 \employer{VSTU \href{URL}{http://www.vstu.edu.ua/}}
 \title{Student}
 \location{Vinnytsia, Ukraine}
 \dates{1994 -- 1998}
 \begin{position}
...
%_________________________________________________________________
 ...
 \employer{Mind/Brain RUMBA Laboratory \href{URL}{http://ravana.rutgers.edu}}
 ...
 \section{Computer Skills}
  \begin{description}
    \item[Programming:] \hspace*{\fill} \\
      \begin{itemize}
      \item More than 3 years of experience with software development
        under Linux OS (C/\Cplusplus(g++), bash/awk/sed, perl, CVS, gdb, ddd,
    ...
    \item[Administration:] \hspace*{\fill} \\
      ...
      \item Linux-based (GNU Debian) computer and network
        communication (TCP/IP, SNMP, IPtables, cfengine2, DNS, BIND,
        NAT, NFS, AMD, SSH, Samba) maintaining.
        \wdescription{Maintaining computer park at {BCL}, {RUMBA} cluster}
    ...
    \item[Web Design and Others:]  \hspace*{\fill} \\
      \begin{itemize}
      \item Web-designer skills (html, css).
        \wdescription{Example is my home page
          \href{URL}{http://www.onerussian.com}}
 ...
 \begin{itemize}
  ...
  \item
     ...
     \mwhere{Presented @ NFSI-2003. Chiety Italy Septeber 2003}
