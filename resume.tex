...
%%}
\address{
  \href{URL}{mailto: yoh@onerussian.com}\\
...
%_________________________________________________________________
 ...
 \employer{Mind/Brain RUMBA Laboratory \href{URL}{http://www.rumba.rutgers.edu}}
  ...
  \begin{description}
    \item[Programming:]\hspace*{\fill}
      ...
      \item Debian package maintainer (impose+, fail2ban, pyepl,
        pyode, etc) and a contributor to the {O}pen{S}ource projects
        (fail2ban, GTKPod, djvu)
    ...
    \item[Administration:] \hspace*{\fill}
      ...
      \item Linux-based (GNU Debian) network communication and
        monitoring (TCP/IP, SNMP, iptables/shorewall, DNS, BIND, NAT, NFS,
        AMD, SSH, OpenVPN, SMTP (Exim v4), Ganglia, samba)
      ...
      \item Distributed computing system (torque, maui)
